...
This script can be used to augment notifications via an OpenAI (or compatible server) vision model.
...
export default class OpenAIMixinProvider extends ScryptedDeviceBase implements MixinProvider {
    storageSettings = new StorageSettings(this, {
        ...
        systemPrompt: {
            ...
            defaultValue: 'Create a notification suitable description of the image provided by the user.',
        }
    });
